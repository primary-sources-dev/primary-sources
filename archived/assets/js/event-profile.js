...
async function loadEventProfile(eventId) {
  ...
  try {
    ...
    const response = await fetch('/docs/ui/assets/data/events.json');
  ...
  if (emptyState) {
    emptyState.innerHTML = `
      <div class="max-w-2xl mx-auto">
        ...
        <a href="/docs/ui/browse/events.html" class="inline-flex items-center gap-2 text-xs text-primary hover:underline uppercase tracking-widest">
