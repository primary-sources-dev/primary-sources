...
**Location:** `web/html/components/pdf-viewer-header.html`
**Pages Using:** pdf-viewer-ui.html (1 page)

---

### 6. Animated Card (`animated-card.html`)

**Usage:**
```html
<div data-component="animated-card" 
     data-title="On This Day" 
     data-status="live" 
     data-icon="auto_awesome"></div>
```

**Features:**
- Icon-based branding
- Status badges (queue, planned, live)
- Hover animations and transitions

**Location:** `web/html/components/animated-card.html`
**Pages Using:** index.html, tools-index.html
...
│   └── animated-card.html    # Animated status card
├── assets/
│   ├── js/
...
│       ├── tailwind-prod.css # Production styles
