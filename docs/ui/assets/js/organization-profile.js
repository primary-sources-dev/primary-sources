...
async function loadOrganizationProfile(orgId) {
  ...
  try {
    ...
    orgData = allOrgs.find(o => o.organization_id === orgId);
  ...
  if (emptyState) {
    emptyState.innerHTML = `
      <div class="max-w-2xl mx-auto">
        ...
        <a href="organizations.html" class="inline-flex items-center gap-2 text-xs text-primary hover:underline uppercase tracking-widest">
