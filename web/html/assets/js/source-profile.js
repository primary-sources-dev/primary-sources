  ...
  if (emptyState) {
    emptyState.innerHTML = `
      <div class="max-w-2xl mx-auto">
        ...
        <a href="${window.basePath || ''}entities/source/source-index.html" class="inline-flex items-center gap-2 text-xs text-primary hover:underline uppercase tracking-widest">
