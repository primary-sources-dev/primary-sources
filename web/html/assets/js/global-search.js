...
(function () {
    ...
    const bPath = window.basePath || "";
    // List of data sources to search through
    const sources = [
        `${bPath}assets/data/events.json`,
        `${bPath}assets/data/people.json`,
        `${bPath}assets/data/organizations.json`,
        `${bPath}assets/data/places.json`,
        `${bPath}assets/data/objects.json`,
        `${bPath}assets/data/sources.json`
    ];
