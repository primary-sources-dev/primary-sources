...
// Using a simpler replace that matches exactly what we have now
js = js.replace(
    /return `\s+<div class="workbench-header flex items-center justify-between py-4 border-b border-primary\/20 mb-6 bg-archive-bg\/95 backdrop-blur z-20">\s+<div class="flex items-center gap-4">\s+<h1 class="text-xl font-bold text-archive-heading tracking-tight underline decoration-primary\/10 decoration-2 underline-offset-8">\$\{title\}<\/h1>\s+<\/div>/,
    `return \`
                ...
                <div class="bg-[#0a0a0a] border border-white/10 w-full max-w-4xl rounded-xl shadow-2xl relative overflow-hidden ring-1 ring-white/5 animate-in fade-in zoom-in duration-300">
                    ...
                    <div class="p-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <!-- Section 1 -->
                            <div class="p-6 rounded-lg bg-white/[0.03] border border-white/5 flex flex-col gap-4 text-left">
